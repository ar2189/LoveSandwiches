...
def get_sales_data():
    ...
    from the user via the terminal, whoich must be a
    string of 6 numbers seperated by commas. The loop
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplus for
    each item type.

    The surplus is defined as the sales figure subtracted from
    the stock:
    - Positive surplus indicates waste.
    - Negative surplus indicates extra madewhen stock was sold
      out.
    """
